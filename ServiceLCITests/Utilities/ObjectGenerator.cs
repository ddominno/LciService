...
namespace ServiceLCITests.Utilities
{
    public class ObjectGenerator
    {
        ...
        public static PostReceipt PostReceipt(string binIdValue)
        {
        ...
        public static PostBinInspectionRemove PostBinInspectionRemove(string binIdValue, string id)
        {
        ...
        public static PostBinInspection PostBinInspection(string binIdValue)
        {
        ...
        public static PostBinAdjustQuantity PostBinAdjustQuantity(string binIdValue)
        {
        ...
        public static PostBinMove PostBinMove(string warehouseNbr, string sublocationNbr, string binIdValue)
        {
        ...
        public static PostBinIssuance PostBinIssuance(string issueTagNbr, string binIdValue)
        {
        ...
        public static PostBinEdit PostBinEdit(string binIdValue)
        {
